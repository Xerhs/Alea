...
//! [`seed_flow::flow_secret::run_secret_flow`].
//!
//! # STEP B dedup
//!
...
//! verbatim with `crates/seed-uefi-test/src/flow_secret/` (see that
//! module's own doc comment for the full rationale). This file is now
//! nothing more than a thin call into that shared driver, passing this
//! edition's own [`crate::flow_pre`]-defined `production_marker`.
